...
class generic_converter:
    ...
    def __init__(self):
        self.header_dict = {}
        self.header_dict_want = ['||_id', '||activity_type', '||activity_name', '||city', '||country', '||font', '||bgcolor', '||version', '||language', 
        '||creation_time', '||creation_hour', '||origin_IP', '||origin_country']
    ...
    def converter_main(self, csv_writer):
        ...
        # print("cursor_records:", cursor_records)
        header_list = []
        ...
        csv_writer.writerow(self.header_dict_want)

        # print("header_list: ", header_list) 
        # print("self.header_dict: ", self.header_dict) 
        # print("self.header_dict_want: ", self.header_dict_want) 
        ...
        for cursor in cursor_records:
            ...
            for item_label in self.header_dict_want:
